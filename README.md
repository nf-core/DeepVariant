...
4. Start running your own analysis!
    ...
    ```bash
    nextflow run nf-core/deepvariant -profile <docker/singularity/conda/institute> --input '*_R{1,2}.fastq.gz' --genome GRCh37
    ```
...
The nf-core/deepvariant pipeline comes with documentation about the pipeline which you can read at [https://nf-core/deepvariant/docs](https://nf-core/deepvariant/docs) or find in the [`docs/` directory](docs).
